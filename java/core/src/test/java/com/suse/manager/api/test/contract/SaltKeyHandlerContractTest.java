...
public class SaltKeyHandlerContractTest extends BaseOpenApiTest {
    ...
    @Override protected String getApiNamespace() { return "saltkey"; }
    @Override protected Class<SaltKeyHandler> getHandlerClass() { return SaltKeyHandler.class; }
    ...
    public void testAcceptedList() throws Exception {
        ...
        validateApiContract("/saltkey/acceptedList", "GET").onHandlerMethod("acceptedList");
    }
    ...
    public void testPendingList() throws Exception {
        ...
        validateApiContract("/saltkey/pendingList", "GET").onHandlerMethod("pendingList");
    }
    ...
    public void testRejectedList() throws Exception {
        ...
        validateApiContract("/saltkey/rejectedList", "GET").onHandlerMethod("rejectedList");
    }
    ...
    public void testDeniedList() throws Exception {
        ...
        validateApiContract("/saltkey/deniedList", "GET").onHandlerMethod("deniedList");
    }
    ...
    public void testAccept() throws Exception {
        ...
        validateApiContract("/saltkey/accept", "POST")
                ...
                .onHandlerMethod("accept", com.redhat.rhn.domain.user.User.class, String.class);
    }
    ...
    public void testReject() throws Exception {
        ...
        validateApiContract("/saltkey/reject", "POST")
                .withBody(Map.of("minionId", minionId))
                .onHandlerMethod("reject", com.redhat.rhn.domain.user.User.class, String.class);
    }
    ...
    public void testDelete() throws Exception {
        ...
        validateApiContract("/saltkey/delete", "POST")
                .withBody(Map.of("minionId", minionId))
                .onHandlerMethod("delete", com.redhat.rhn.domain.user.User.class, String.class);
    }
}
